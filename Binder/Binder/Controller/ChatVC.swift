...
//  Binder
//
//  Created by Boyce Whisenant on 12/12/18.
...
class ChatVC: UIViewController, UITableViewDelegate, UITableViewDataSource, UITextViewDelegate  {
    ...
    override func viewDidLoad() {
        ...
        DataService.instance.getName(forUid: userUid!) { (name) in
    ...
    @IBAction func sendPressed(_ sender: AnyObject) {
        ...
        let messagesDB = DataService.instance.REF_CHATS.child(chatID!)
    ...
    func retrieveMessages() {
        ...
        let messageDB = DataService.instance.REF_CHATS.child(chatID!)
